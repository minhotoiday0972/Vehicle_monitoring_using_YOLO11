...
model_path = os.path.join(current_dir, "../../runs/detect/train18/weights/best.pt")  # Đường dẫn tương đối đến model
...
if not os.path.exists(model_path):
    print("❌ Lỗi: Không tìm thấy tệp best.pt. Hãy đảm bảo bạn đã huấn luyện xong và model được lưu đúng cách!")
    sys.exit()
